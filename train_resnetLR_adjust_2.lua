...
--to do
--restrick_en              (default true)             restrick enable
--resume                   (default true)          resume training
...
-- learning rate: adjusts for no data aug
  if epoch <= 20  then
    optimState.learningRate = 0.1
  elseif epoch <= 30 then
    optimState.learningRate = 0.01
  else
    optimState.learningRate = 0.001
  end
  
  print(c.blue '==>'.." online epoch # " .. epoch .. ' [batchSize = ' .. opt.batchSize .. ']' .." LR: " .. optimState.learningRate)
